...
var { attachPairMessage } = require("./project-pair-message"), { attachPairTaskControl } = require("./project-pair-task-control"), stopAutonomous = require("./project-pair-autonomous-stop").stopAutonomousWork;
...
function attachSessionPair(ctx) {
  ...
  return { beginHumanTurn: beginHumanTurn, getToolDefs: getToolDefs, handleHumanStop: handleHumanStop, stopAutonomousWork: stopAutonomousWork, stopBarrier: stopBarrier,
