...
function attachUserMessage(ctx) {
  ...
  function handleUserMessage(ws, msg, forcedSession, internal) {
    ...
    if (msg.type === "cancel_scheduled_message") {
      ...
      cancelScheduledMessage(cancelSession, ws._clayUser || null, ws, { jobId: msg.jobId, revision: msg.revision });
      return true;
    }
    ...
    if (msg.type === "send_scheduled_now") {
      ...
      sendScheduledMessageNow(nowSession, ws._clayUser || null, ws, { jobId: msg.jobId, revision: msg.revision });
      return true;
    }
