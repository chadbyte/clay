...
var ATTENTION_CONTRACT =
  ...
  "Project Issues are the primary record for concrete actionable bugs, improvements, and deferred implementation. " + require("./issues-filing-guidance").FILING_GUIDANCE + require("./issues-filing-guidance").NOTE_GUIDANCE +
