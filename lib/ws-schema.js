...
var schema = {
  ...
  "new_session_result":       { direction: "s2c", handler: "lib/public/modules/scheduled-tasks.js", description: "Correlated result for a requested new session" },
  ...
  "split_worker_close":       { direction: "c2s", handler: "lib/project-pair-worker-close.js", description: "Close one exact authenticated Worker generation while preserving its peer and session history" },
  "split_worker_close_result": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Correlated result of an exact targeted Worker close" },
  ...
  "issues_list": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issues list" },
  "issue_read": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue read" },
  "issue_create": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue create" },
  "issue_update": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue update" },
  "issue_history": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue history" },
  "issue_revision": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue revision" },
  "issue_start_work": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue start work" },
  "issue_open_work": { direction: "c2s", handler: "lib/project-issues.js", description: "Project Issues issue open work" },
  "issue_comment": { direction: "c2s", handler: "lib/project-issues.js", description: "Append an attributed Issue comment" },
  "issue_delete": { direction: "c2s", handler: "lib/project-issues.js", description: "Delete an Issue (project owner only; append-only tombstone)" },
  "issues_result": { direction: "s2c", handler: "lib/public/modules/issues.js", description: "Project Issues issues result" },
  "issue_updated": { direction: "s2c", handler: "lib/public/modules/issues.js", description: "Project Issues issue updated" },
  "issue_commented": { direction: "s2c", handler: "lib/public/modules/issues.js", description: "Issue after an attributed comment" },
  "issue_deleted": { direction: "s2c", handler: "lib/public/modules/issues.js", description: "Issue deletion notification" },
  "issue_reference_resolve": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Project Issues issue reference resolve" },
  "issue_reference_result": { direction: "s2c", handler: "lib/public/modules/clay-issue-links.js", description: "Project Issues issue reference result" },
  ...
  "scheduled_tasks_list":     { direction: "c2s", handler: "lib/project-scheduled-tasks.js", description: "List project schedules for the active Driver session" },
  "scheduled_tasks_state":    { direction: "s2c", handler: "lib/public/modules/scheduled-tasks.js", description: "Correlated Scheduled Tasks workbench list" },
  "scheduled_task_interview_start": { direction: "c2s", handler: "lib/project-scheduled-tasks.js", description: "Begin the built-in interview in a newly selected Driver session" },
  "scheduled_task_interview_start_result": { direction: "s2c", handler: "lib/public/modules/scheduled-tasks.js", description: "Correlated schedule interview start result" },
  "scheduled_task_interview_state": { direction: "s2c", handler: "lib/public/modules/scheduled-tasks.js", description: "Session-bound schedule proposal state" },
  "scheduled_task_manual_start": { direction: "c2s", handler: "lib/project-scheduled-tasks.js", description: "Start or resume a blank manual schedule draft in the current Driver session" },
  "scheduled_task_manual_start_result": { direction: "s2c", handler: "lib/public/modules/scheduled-tasks.js", description: "Correlated manual schedule draft start result" },
  "scheduled_task_create":    { direction: "c2s", handler: "lib/project-scheduled-tasks.js", description: "Create a schedule from an exact pending proposal" },
  ...
  "message_ack":              { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Confirm that an idempotent user chat message was persisted, correlated to its exact project session" },
  ...
  "scheduled_message_state":  { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Authoritative pending scheduled message state after session history replay" },
  ...
  "pending_message_get":      { direction: "c2s", handler: "lib/project-user-message.js", description: "Get the exact active session's pending-message queue and canonical paused state" },
  "pending_message_edit":     { direction: "c2s", handler: "lib/project-user-message.js", description: "Edit owned pending-message text and images using exact session and queue revision guards" },
  "pending_message_cancel":   { direction: "c2s", handler: "lib/project-user-message.js", description: "Cancel an owned pending or claimed message using exact session and queue revision guards" },
  "pending_message_reorder":  { direction: "c2s", handler: "lib/project-user-message.js", description: "Reorder the requesting user's pending messages using an exact validated permutation" },
  "pending_message_resume":   { direction: "c2s", handler: "lib/project-user-message.js", description: "Explicitly resume a canonically paused queue using exact session and queue revision guards" },
  "pending_message_result":   { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Correlated pending-message request result with exact session, project, revision, items, and paused state" },
  "message_queued":           { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Sender acknowledgement that a chat message is represented by pending queue state" },
  "pending_message_queued":   { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Authorized session-viewer notification for a newly queued message" },
  "pending_message_state":    { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Authoritative pending-message queue revision, items, and paused state" },
  "pending_message_claimed":  { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Authorized notification that one pending item is reserved for delivery" },
  "pending_message_consumed": { direction: "s2c", handler: "lib/public/modules/pending-message-queue.js", description: "Authorized terminal notification after SDK acceptance or delivery failure" },
  ...
  "permission_mode_result":   { direction: "s2c", handler: "lib/public/modules/permission-control.js", description: "Correlated result for an exact project/session permission mode change" },
  ...
  "autonomous_run_arm":        { direction: "c2s", handler: "lib/project-autonomous-run.js", description: "Arm an Until complete task with request identity, limits, and server-persisted success criteria after enabling Skip Permissions" },
  "loop_interview_start":      { direction: "c2s", handler: "lib/project-loop-interview.js", description: "Start a server-owned built-in Loop interview in the exact current Driver session" },
  "loop_interview_state":      { direction: "c2s", handler: "lib/project-loop-interview.js", description: "Request the persisted Loop interview brief for the exact current session" },
  "loop_interview_start_run":  { direction: "c2s", handler: "lib/project-loop-interview.js", description: "Human-approved handoff from a persisted Loop brief into the existing arm lifecycle" },
  "loop_interview_edit":       { direction: "c2s", handler: "lib/project-loop-interview.js", description: "Edit a persisted Loop brief before human approval" },
  "loop_interview_cancel":     { direction: "c2s", handler: "lib/project-loop-interview.js", description: "Cancel a persisted Loop brief" },
  "autonomous_run_disarm":     { direction: "c2s", handler: "lib/project-autonomous-run.js", description: "Deselect an exact armed Until complete run with correlated request and run identity" },
  "autonomous_run_stop":       { direction: "c2s", handler: "lib/project-autonomous-run.js", description: "Stop an exact active Until complete run with correlated request and run identity" },
  "autonomous_run_resume":     { direction: "c2s", handler: "lib/project-autonomous-run.js", description: "Explicitly resume an exact run paused after restart with correlated request and run identity" },
  "autonomous_run_arm_result": { direction: "s2c", handler: "lib/public/modules/autonomous-run.js", description: "Session- and request-correlated Until complete arm acknowledgement with the persisted run criteria" },
  "autonomous_run_action_result": { direction: "s2c", handler: "lib/public/modules/autonomous-run.js", description: "Session-, run-, and request-correlated Until complete action acknowledgement" },
  "autonomous_run_state":      { direction: "s2c", handler: "lib/public/modules/autonomous-run.js", description: "Synchronized Until complete run state" },
  ...
  "mcp_permission_mode_result": { direction: "s2c", handler: "lib/public/modules/mcp-ui.js", description: "Correlated result for one session MCP AI review policy change" },
  ...
  "cursor_sharing_get":        { direction: "c2s", handler: "lib/server-cursor-sharing.js", description: "Request the authenticated user's cursor sharing preference" },
  "cursor_sharing_set":        { direction: "c2s", handler: "lib/server-cursor-sharing.js", description: "Persist the authenticated user's cursor sharing preference" },
  "cursor_sharing_state":      { direction: "s2c", handler: "lib/public/modules/cursor-sharing-preference.js", description: "Cursor sharing preference and hydration state" },
  ...
  "home_dock_get":            { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Request the current user's home dock preference" },
  "home_dock_set":            { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Persist the current user's home dock preference" },
  "home_dock_state":          { direction: "s2c", handler: "lib/public/modules/home-dock.js", description: "Current user home dock preference" },
  "home_surface_get":         { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Request the current user's durable primary surface and Home conversation selection" },
  "home_surface_set":         { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Persist the current user's primary surface and Home conversation selection" },
  "home_surface_state":       { direction: "s2c", handler: "lib/public/modules/home-surface.js", description: "Current user primary surface and Home conversation selection" },
  "home_debates_list":        { direction: "c2s", handler: "lib/server-home-debates.js", description: "Request the current user's durable Home debate archive" },
  "home_debates_state":       { direction: "s2c", handler: "lib/public/modules/home-debates-archive.js", description: "Current user's durable Home debate archive" },
  ...
  // -----------------------------------------------------------------------
  // User-installed home tools
  // -----------------------------------------------------------------------
  "tools_list":               { direction: "c2s", handler: "lib/server-tools.js", description: "List installed tool definitions" },
  "tool_get":                 { direction: "c2s", handler: "lib/server-tools.js", description: "Get one installed tool definition" },
  "tool_install":             { direction: "c2s", handler: "lib/server-tools.js", description: "Install a new declarative tool" },
  "tool_source_get":          { direction: "c2s", handler: "lib/server-tools.js", description: "Read authored Capsule source for the current user" },
  "tool_mate_access_set":     { direction: "c2s", handler: "lib/server-tools.js", description: "Set whether Mates may inspect and edit one Capsule" },
  "tool_remove":              { direction: "c2s", handler: "lib/server-tools.js", description: "Remove an installed tool" },
  "tool_storage_op":          { direction: "c2s", handler: "lib/server-tools.js", description: "Run an operation against scoped tool storage" },
  ...
  "tool_mate_access_state":   { direction: "s2c", handler: "lib/public/modules/home-capsule-source.js", description: "Server-confirmed Mate editing permission" },
  "tool_removed":             { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "An installed tool was removed" },
  "tool_storage_result":      { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Result of a scoped tool storage operation" },
  ...
  "debate_proposal_response": { direction: "c2s", handler: "lib/project.js", description: "Respond to a debate proposal with optional per-participant model overrides" },
  ...
  "debate_tool_decision":     { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Moderator tool permission decision for a debate participant" },
  "debate_stop_requested":    { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Debate will stop after the active turn" },
  "debate_stop_cancelled":    { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Pending debate stop was cancelled" },
  ...
  // Embedded mate chat
  // -----------------------------------------------------------------------
  "home_mate_open":           { direction: "c2s", handler: "lib/server-home-chat.js", description: "Open or restore the selected mate's embedded chat session" },
  "home_clay_ask":            { direction: "c2s", handler: "lib/server-home-chat.js", description: "Start a fresh builtin Clay conversation from the global search drawer" },
  ...
  "home_mate_creation_question_response": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Answer an exact pending question in a Clay-led Mate creation interview" },
  "home_mate_creation_proposal_response": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Approve or cancel an exact Mate creation proposal" },
  "home_debate_proposal_response": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Approve or cancel an exact Home debate proposal with optional per-participant model overrides" },
  "home_debate_question_response": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Answer the exact pending AskUserQuestion in an owned Home debate planning session" },
  "home_debate_control":      { direction: "c2s", handler: "lib/server-home-chat.js", description: "Control or resume the exact owned Home debate session" },
  "home_mate_close":          { direction: "c2s", handler: "lib/server-home-chat.js", description: "Tear down the embedded mate session tap" },
  "home_mate_present":        { direction: "c2s", handler: "lib/server-home-chat.js", description: "Report whether Home is visibly presenting its active exact Mate conversation" },
  "home_mate_memory_list":    { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request a correlated read-only memory projection for one owned Mate" },
  "home_mate_knowledge_list": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request a correlated read-only knowledge file list for one owned Mate" },
  "home_mate_models_get":     { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request an available vendor and model catalog for the selected Mate" },
  ...
  "default_ai_get":           { direction: "c2s", handler: "lib/server-default-ai.js", description: "Read the authenticated user's shared Default AI and available providers" },
  "default_ai_catalog_get":   { direction: "c2s", handler: "lib/server-default-ai.js", description: "Read one installed provider catalog for the Default AI picker" },
  "default_ai_set":           { direction: "c2s", handler: "lib/server-default-ai.js", description: "Validate and persist the authenticated user's shared Default AI" },
  ...
  "home_debate_question":     { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Session-bound AskUserQuestion card for Home debate planning" },
  "home_debate_question_resolved": { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Server-confirmed answer or expiry for a Home debate question" },
  "home_debate_event":       { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Correlated live debate event for the active Home transcript" },
  "home_mate_creation_question": { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Session-bound question in a Clay-led Mate creation interview" },
  "home_mate_creation_question_resolved": { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Server-confirmed Mate interview answer or expiry" },
  "home_mate_creation_proposal": { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Session-bound new Mate proposal" },
  "home_mate_creation_proposal_resolved": { direction: "s2c", handler: "lib/public/modules/app-message-router.js", description: "Server-confirmed result for a Mate creation proposal" },
  "home_mate_error":          { direction: "s2c", handler: "lib/public/modules/home-mate-chat.js", description: "Embedded mate chat error" },
  "home_mate_memory_state":   { direction: "s2c", handler: "lib/public/modules/home-mate-settings.js", description: "Selected mate's read-only memory summary and entries" },
  "home_mate_knowledge_state": { direction: "s2c", handler: "lib/public/modules/home-mate-settings.js", description: "Selected mate's read-only knowledge file list" },
  "home_mate_models_state":   { direction: "s2c", handler: "lib/public/modules/home-mate-settings.js", description: "Correlated Mate model catalog state" },
  "home_mate_model_result":   { direction: "s2c", handler: "lib/public/modules/home-mate-settings.js", description: "Correlated Mate model selection result" }
};
