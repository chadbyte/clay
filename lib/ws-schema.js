...
var schema = {
  ...
  "pending_message_edit":     { direction: "c2s", handler: "lib/project-user-message.js", description: "Edit owned pending-message text using exact session and queue revision guards" },
