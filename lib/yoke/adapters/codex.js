...
function flattenEvent(notification, state) {
  ...
  if (method === "turn/completed") {
    ...
    var hasVerifiedContextUsage = state.lastInputTokens !== null && state.lastInputTokens !== undefined;
    var inputTokens = hasVerifiedContextUsage
    ...
    resultModelUsage[state.model] = {
      ...
      contextUsageVerified: hasVerifiedContextUsage,
    };
    ...
    events.push({
      ...
      lastStreamInputTokens: hasVerifiedContextUsage ? state.lastInputTokens : null,
    });
