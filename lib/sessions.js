...
function createSessionManager(opts) {
  ...
  function loadSessions() {
    ...
    for (var i = 0; i < files.length; i++) {
      ...
      var pendingOrigin = typeof meta.sessionOriginId === "string" && meta.sessionOriginId.trim() && meta.sessionOriginId.length <= 128;
      if (meta.type !== "meta" || (!meta.cliSessionId && !pendingOrigin)) continue;
