  ...
  function handleSessionsMessage(ws, msg) {
    ...
    if (msg.type === "new_session") {
      if (msg.scheduleInterview === true) {
        ...
        var engineError = "";
        if (!sourceSession || Number(msg.sourceSessionId) !== Number(sourceSession.localId) || msg.projectSlug !== slug || !ctx.canStartScheduledTaskInterview || !ctx.canStartScheduledTaskInterview(ws, sourceSession)) engineError = "Scheduled Tasks is unavailable in the current project session.";
