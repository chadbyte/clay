...
function createProjectContext(opts) {
  ...
  function runNextIteration() {
    ...
    session.loop = { active: true, iteration: loopState.iteration, role: "coder", loopId: loopState.loopId, name: loopName, source: loopSourceTag };
  ...
  function runJudge() {
    ...
    judgeSession.loop = { active: true, iteration: loopState.iteration, role: "judge", loopId: loopState.loopId, name: judgeName, source: judgeSourceTag };
  ...
  function handleMessage(ws, msg) {
    ...
    if (msg.type === "ralph_wizard_complete") {
      ...
      craftingSession.loop = { active: true, iteration: 0, role: "crafting", loopId: newLoopId, name: craftName, source: "ralph" };
