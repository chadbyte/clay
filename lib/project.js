...
function createProjectContext(opts) {
  ...
  function scheduleMessage(session, text, resetsAt, actorUser, targetWs) {
    return _scheduledMessages ? _scheduledMessages.schedule(session, text, resetsAt, actorUser, targetWs) : null;
  }
