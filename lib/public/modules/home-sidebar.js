...
function renderMatesState() {
  var section = document.querySelector(".home-sidebar-mate-section");
  var toggle = document.getElementById("home-sidebar-mate-label");
  if (!section || !toggle) return;
  var collapsed = store.get('homeMatesCollapsed') === true;
  section.classList.toggle("home-sidebar-mates-collapsed", collapsed);
...
function toggleMates() {
  updateHomeSurfacePreference({ matesCollapsed: store.get('homeMatesCollapsed') !== true });
}
...
export function initHomeSidebar() {
  ...
  document.getElementById("home-sidebar-mate-label").addEventListener("click", toggleMates);
  ...
  store.subscribe(function (state, prev) {
    ...
    if (state.homeMateSessions !== prev.homeMateSessions || state.homeChatMateId !== prev.homeChatMateId || state.homeChatSessionId !== prev.homeChatSessionId || state.homeSidebarCollapsed !== prev.homeSidebarCollapsed || state.homeMatesCollapsed !== prev.homeMatesCollapsed || state.homeChatScope !== prev.homeChatScope) {
      renderSidebarState();
    }
  });
