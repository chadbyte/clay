...
export function renderPermissionRequest(requestId, toolName, toolInput, decisionReason, mateId, vendor, hints) {
  ...
  if (toolName === "ExitPlanMode") {
    ...
    applyPermissionHints(pendingPermissions[requestId], { defaultToNo: hints && hints.defaultToNo });
    return;
  }
  ...
  if ((ctx.isMateDm && ctx.isMateDm()) || getChatLayout() === "channel") {
    ...
    applyPermissionHints(pendingPermissions[requestId], hints);
    return;
  }
