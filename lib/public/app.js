import { initIssueLinks } from './modules/clay-issue-links.js';
import { initIssues, closeIssues } from './modules/issues.js';
import { initIssuesContext } from './modules/issues-context.js';
...
// --- DOM refs ---
  ...
  createStore({
    ...
    githubWorkPopoverBound: false,
    githubWorkSessions: [],
    githubWorkProject: null,
    githubWorkRefresh: null,
    ...
    pendingMessageQueue: { projectSlug: null, sessionId: null, revision: 0, paused: false, items: [], loading: false, error: "" },
    pendingMessageQueueRecovery: false,
    pendingMessageQueueRequests: {},
    pendingMessageQueueEdit: null,
    ...
    permissionCapabilities: { auto: false, mcpOverride: false },
