...
> Concrete unresolved bugs, improvements, and deferred implementation belong proactively in Project Issues: authorized Drivers search/reuse/create the Issue without waiting for another user request and record evidence, impact, affected component, next action, acceptance criteria, remediation, and verification there; Sticky Notes remain for preferences, reminders, undeveloped ideas, or explicit memory requests, while Project Logs retain concise continuity and reference related Issues.
